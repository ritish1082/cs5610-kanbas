              ...
              <li className="wd-lesson list-group-item p-3 ps-1">
                ...
                <div className="position-absolute top-50 start-50 translate-middle w-75">
                  ...
                  <p>
                    ...
                    <b>Not Available until</b> {assignment.unlock.split("T")[0]} at{" "}
                    {assignment.unlock.split("T")[1]} | <b>Due</b> {assignment.due.split("T")[0]} at{" "}
                    {assignment.due.split("T")[1]} | {assignment.points} pts
                  </p>
                </div>
                {!disabled && (
